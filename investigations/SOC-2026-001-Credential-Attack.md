...
Analysis identified 47 failed Windows Event ID 4625 events within a five-minute window originating from external IP address **185.234.10.77**. Threat intelligence enrichment confirmed the source IP has a high malicious reputation score.

No successful authentication (Event ID 4624) was observed. The account was automatically locked after policy threshold was reached (Event ID 4740).
...
- No approved red team or penetration testing activity scheduled

Assessment: Suspicious activity consistent with brute force credential attack.

---

# 4. Technical Investigation

## 4.1 Splunk Log Analysis
...
Findings:
- 47 failed login attempts within 5 minutes
- All attempts targeted account: j.smith
- Source IP: 185.234.10.77
- Average rate: 2–3 attempts per second
- No lateral authentication attempts detected
...
## 4.2 Successful Logon Verification
...
Reason:
Confirmed malicious IP performing credential attack behavior against enterprise asset.
