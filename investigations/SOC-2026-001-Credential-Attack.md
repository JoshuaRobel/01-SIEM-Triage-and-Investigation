...
### 4.1 Failed Authentication Analysis
...
- Perimeter firewall block implemented  
- User account temporarily disabled  
- Password reset enforced  
- Monitoring window extended  
...
- Lower failed login threshold  
- Correlate 4625 burst with 4624 success  
- Detect single IP targeting multiple accounts  
- Enable geo-velocity alerting  

---

## 10. Escalation Decision

Escalated to Tier 2 SOC due to confirmed malicious infrastructure targeting enterprise credentials.
